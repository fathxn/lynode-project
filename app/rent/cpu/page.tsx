...
import { Cpu, HardDrive, Zap, DollarSign, Clock, Shield, Filter, Search, TrendingUp } from 'lucide-react';
...
export default function CPURentalPage() {
  ...
  const cpuPools = STAKING_POOLS.filter(pool => pool.type === 'CPU');
  ...
  const filteredPools = cpuPools.filter(pool => {
    ...
    const matchesFilter = selectedFilter === 'all' || 
                         ...
                         (selectedFilter === 'high-apy' && pool.apy >= 9) ||
                         (selectedFilter === 'low-stake' && parseFloat(pool.stakeAmount) <= 0.035);
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center">
      ...
      >
        ...
        <p className="text-gray-400 mb-6">
          To stake in CPU pools and earn rewards, please connect your wallet first.
        </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
              CPU <span className="text-purple-400">Staking Pools</span>
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Stake ETH in CPU pools and earn rewards while supporting decentralized computing infrastructure.
            </p>
          </motion.div>
